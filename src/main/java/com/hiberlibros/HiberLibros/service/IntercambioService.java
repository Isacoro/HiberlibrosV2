...
import com.hiberlibros.HiberLibros.repository.IntercambioRepository;
 ...
 */
@Service
public class IntercambioService implements IntercambioServiceImpl {

    @Autowired
    private IntercambioRepository repoInter;

    @Autowired
    private UsuarioLibroServiceImpl serviceUL;
